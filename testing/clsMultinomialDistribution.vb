Public Class clsMultinomialDistribution
    ...
    Function int_simulate(n As Integer, rnd As clsRandomNumberGenerator) As Integer()
        Dim res(p.GetUpperBound(0)) As Integer

        For i As Integer = 1 To n
            'simulate
            Dim toss As Integer
            toss = Me.intQuantileFunction(rnd.SU)
            res(toss) = res(toss) + 1
        Next
    ...
    Function dbl_simulate(n As Integer, rnd As clsRandomNumberGenerator) As Double()
    ...
    Public Function simulate(rnd As clsRandomNumberGenerator) As Double
        Return -1
    End Function
